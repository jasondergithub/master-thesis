    ...
    for i, batch in enumerate(dev_batch):
        ...
        for id,now in enumerate(now_list):
            ...
            add_metric(recommend_list[:10], ALL_group_list, precision_list10, recall_list10, ap_list10, rr_list10,
                       ndcg_list10)
            add_metric(recommend_list[:20], ALL_group_list, precision_list20, recall_list20, ap_list20, rr_list20,
                       ndcg_list20)

    metric_dict[1] =  cal_metric(precision_list1, recall_list1, ap_list1, rr_list1, ndcg_list1)
    metric_dict[3] = cal_metric(precision_list3, recall_list3, ap_list3, rr_list3, ndcg_list3)
    metric_dict[5] = cal_metric(precision_list5, recall_list5, ap_list5, rr_list5, ndcg_list5)
    metric_dict[10] = cal_metric(precision_list10, recall_list10, ap_list10, rr_list10, ndcg_list10)
    metric_dict[20] = cal_metric(precision_list20, recall_list20, ap_list20, rr_list20, ndcg_list20)
    precision,recall,f1,mndcg,mmap,mmrr = metric_dict[opt["topn"]]
